                        ...
                        <b-card>
                            <b-form @submit="onSubmit" @reset="onReset" v-if="show">
                                <b-row>
                                    ...
                                    <b-col lg="3" md="12">
                                        <picture-input ref="pictureInput" width="80" height="80" margin="16"
                                            :removable="true" accept="image/jpeg,image/png" size="10" button-class="btn"
                                            :custom-strings="{
                                                drag: 'Profile Photo',
                                                aspect: 'Portrait',
                                                change: 'Change Photo',
                                        ...
                                        <b-row>
                                            ...
                                            <b-col md="4" sm="6">
                                                <b-form-group id="form-Nationality" label="Nationality:"
                                                    ...
                                                    <Multiselect class="multi-table" placeholder="Please Select"
                                    ...
                                    <b-col lg="3" md="4" sm="6">
                                        <b-form-group id="form-PassportNo" label="Passport No:" label-for="PassportNo">
                                            <b-form-input id="PassportNo" v-model="form.PassportNo"
                                                placeholder="Passport No" required></b-form-input>
                                        </b-form-group>
                                    </b-col>
                                    <b-col lg="3" md="4" sm="6">
                                    ...
                                    <b-col lg="3" md="4" sm="6">
                                        <b-form-group id="form-PermitExpiry" label="Permit Expiry:"
                                            label-for="PermitExpiry">
                                            <VueDatePicker v-model="date"></VueDatePicker>
                                        </b-form-group>
                                    </b-col>
                                    <b-col lg="3" md="4" sm="6">
                                ...
                                <b-row>
                                    ...
                                    <b-col lg="3" md="4" sm="6">
                                        <b-form-group id="form-CurrentStreet" label="Current Street:"
                                    ...
                                    <b-col lg="3" md="4" sm="6">
                                        <b-form-group id="form-CurrentTown" label="Current Town:" label-for="CurrentTown">
                                            <b-form-input id="CurrentTown" v-model="form.CurrentTown"
                                                placeholder="Current Town" required></b-form-input>
                                        </b-form-group>
                                    </b-col>
                                    <b-col lg="3" md="4" sm="6">
                                    ...
                                    <b-col lg="3" md="4" sm="6">
                                        <b-form-group id="form-CurrentState" label="Current State:"
                                    ...
                                    <b-col lg="3" md="4" sm="6">
                                        <b-form-group id="form-PermanentTown" label="Permanent Town:"
                                            label-for="PermanentTown">
                                ...
                                <b-row>
                                    ...
                                    <b-col lg="3" md="4" sm="6">
                                        <b-form-group id="form-TelephoneNo" label="Telephone No:" label-for="TelephoneNo">
                                            <b-form-input id="TelephoneNo" v-model="form.TelephoneNo"
                                                placeholder="Telephone No" required></b-form-input>
                                        </b-form-group>
                                    </b-col>
                                </b-row>
                                <div class="text-end">
